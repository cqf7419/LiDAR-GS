...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        self.data_label = "waymo"
        self.sh_degree = 3
        self.color_channel = 2 # intensity + raydrop
        self.feat_dim = 32
        self.n_offsets = 6
        ...
        self.appearance_dim = 0 # 32 using embedding model
        self.lowpoly = False
        self.ds = 1
        ...
        self.add_opacity_dist = True # waymo1076需要打开 
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.offset_lr_init = 0.005 #0.01
        self.offset_lr_final = 0.00001 # 0.00001
        self.offset_lr_delay_mult = 0.01
        self.offset_lr_max_steps = 10000
        ...
        self.mlp_opacity_lr_final = 0.0002
        self.mlp_opacity_lr_delay_mult = 0.01
        self.mlp_opacity_lr_max_steps = 10000

        self.mlp_cov_lr_init = 0.004
        self.mlp_cov_lr_final = 0.0004 # 0.004
        self.mlp_cov_lr_delay_mult = 0.01
        self.mlp_cov_lr_max_steps = 10000
        
        self.mlp_color_lr_init = 0.008
        self.mlp_color_lr_final = 0.00005
        self.mlp_color_lr_delay_mult = 0.01
        self.mlp_color_lr_max_steps = 10000
        ...
        self.mlp_featurebank_lr_init = 0.001 # 没使用
        self.mlp_featurebank_lr_final = 0.00001
        self.mlp_featurebank_lr_delay_mult = 0.01
        self.mlp_featurebank_lr_max_steps = 10000

        self.appearance_lr_init = 0.05
        self.appearance_lr_final = 0.00005
        self.appearance_lr_delay_mult = 0.01
        self.appearance_lr_max_steps = 10000
        ...
        self.update_until = 7000
        
        self.min_opacity = 0.005
        self.success_threshold = 0.1
        self.densify_grad_threshold = 0.0005  # waymo 0.0005 (raydrop grad)
        self.densify_until_num_points = 1200000 
