...
class GaussianModel:
    ...
    def __init__(
        ...
        self.use_pose_correction = use_pose_correction
    ...
    def create_from_pcd(self, pcd: BasicPointCloud, spatial_lr_scale: float):
        ...
        print("Initial voxel size: ", self.voxel_size)
        print("Voxel points size: ", points.shape)
    ...
    def training_setup(self, training_args):
        ...
        self.offset_gradient_accum = torch.zeros(
            (self._anchor.shape[0] * self.n_offsets, 1), device="cuda"
        )
        ...
        if self.use_feat_bank:
            l = [
                ...
                {
                    "params": [self._offset],
                    "lr": training_args.offset_lr_init,
                    "name": "offset",
                },
                {
        ...
        self.offset_scheduler_args = get_expon_lr_func(
            lr_init=training_args.offset_lr_init,
        ...
        self.mlp_raydrop_scheduler_args = get_expon_lr_func(
            lr_init=training_args.mlp_color_lr_init,
            lr_final=training_args.mlp_color_lr_final,
            lr_delay_mult=training_args.mlp_color_lr_delay_mult,
            max_steps=training_args.mlp_color_lr_max_steps)
    ...
    def adjust_anchor(self, check_interval=100, success_threshold=0.8, grad_threshold=0.0001, min_opacity=0.005, abs_grad_f = 1.0):
        ...
        self.anchor_growing(grads_norm, grad_threshold * abs_grad_f, offset_mask)
