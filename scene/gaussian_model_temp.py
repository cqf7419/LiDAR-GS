...
class GaussianModel:
    ...
    def __init__(self, 
        ...
        self.mlp_color = nn.Sequential(
            ...
            nn.ReLU(True),
            nn.Linear(feat_dim, (self.color_channel-1)*self.n_offsets), # 对于lidar的intensity来说只有一通道
            nn.Sigmoid()                            # if using new raydrop mlp, should (self.color_channel-1)
        ).cuda()
        ...
        # self.mlp_raydrop = tcnn.Network(
        #     n_input_dims=feat_dim+3+self.color_dist_dim +self.appearance_dim,
        #     n_output_dims=1*self.n_offsets,
        #     network_config={
        #         "otype": "FullyFusedMLP",
        #         "activation": "ReLU",
        #         "output_activation": "Sigmoid",
        #         "n_neurons": feat_dim*2,
        #         "n_hidden_layers": 2,
        #     },
        # )
    ...
    def training_statis(self, viewspace_point_tensor_grad, opacity, update_filter, offset_selection_mask, anchor_visible_mask):
        ...
        abs_grad_norm = torch.norm(viewspace_point_tensor_grad[update_filter, 2:], dim=-1,keepdim=True)
