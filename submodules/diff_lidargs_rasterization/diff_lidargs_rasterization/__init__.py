...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            num_rendered, color, depth, occ, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        # return color, radii
        return color, depth, occ, radii

    @staticmethod
    def backward(ctx, grad_out_color, grad_out_depth, grad_out_occ, _):  # 梯度收入对齐forward的输出
